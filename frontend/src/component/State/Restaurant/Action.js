...
import { CREATE_CATEGORY_FAILURE,
 ...
 export const getRestaurantById = (reqData) =>{
    return async (dispatch) =>{
        ...
        try {
            const respone = await api.get(`api/restaurants/${reqData.restaurantId}`,{
                headers:{
                    Authorization: `Bearer ${reqData.jwt}`,
                },
            });
            dispatch({type:GET_RESTAURANT_BY_ID_SUCCESS, payload:respone.data})
            // console.log("all restaurant",respone.data);
        } catch (error) {
            console.log("cartch error", error);
 ...
 export const updateRestaurant = ({ restaurantId, data, jwt }) => {
    return async (dispatch) => {
...
export const deleteRestaurant = ({ restaurantId, jwt }) => {
 ...
 export const updateRestaurantStatus = ({ restaurantId, jwt}) => {
    return async (dispatch) =>{
        ...
        try {
            const res = await 
            api.put(`/api/admin/restaurants/${restaurantId}/status`,
                {},
                {
                    headers:{
                        Authorization: `Bearer ${jwt}`,
...
export const createEventAction = ({data, jwt, restaurantId}) =>{
    return async (dispatch) =>{
        ...
        try {
            ...
            // console.log("create event action", res.data);
...
export const getRestaurantEvents = ({restaurantId, jwt}) =>{
    return async (dispatch) =>{
        ...
        try {
            ...
            console.log("error get restaurant event", error);
...
export const createCategoryAction =({reqData, jwt}) => {
    return async (dispatch) =>{
        ...
        try {
            ...
            console.log("error create category action", error);
