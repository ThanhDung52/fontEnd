import { Box, Button, Card, CardContent, CardHeader, Grid, Modal, useTheme } from "@mui/material";
...
export const RestaurantDetails = () => {
    ...
    return (
        <Box>
            <div className="lg:px-20 px-5 pb-10" style={{ color: theme.palette.text.secondary }}>
                <div className="py-5 flex justify-center items-center gap-5">
                    <h1 className="text-2xl lg:text-7xl text-center font-bold p-5" style={{ color: theme.palette.text.secondary }}>
                ...
                <Grid container spacing={2}>
                    <Grid item xs={12}>
                        <Card>
                            <CardHeader title={<span className="text-gray-300" style={{ color: theme.palette.text.secondary }}>Restaurant</span>} />
                            <CardContent>
                                <div className="space-y-4 text-gray-200">
                                    <div className="flex">
                                        <p className="w-48"style={{ color: theme.palette.text.secondary }}>Owner</p>
                                        <p className="text-gray-400" style={{ color: theme.palette.text.secondary }}>
                                            <span className="pr-5" style={{ color: theme.palette.text.secondary }}>-</span>
                                            {restaurant.userRestaurant?.owner?.fullname}
                                        </p>
                                    </div>
                                    <div className="flex" style={{ color: theme.palette.text.secondary }}>
                    ...
                    <Grid item xs={12} lg={6}>
                        <Card>
                            <CardHeader title={<span className="text-gray-300" style={{ color: theme.palette.text.secondary }}>Address</span>} />
                            <CardContent>
                                <div className="space-y-4 text-gray-200" style={{ color: theme.palette.text.secondary }}>
                                    <div className="flex">
                    ...
                    <Grid item xs={12} lg={6} >
                        <Card>
                            <CardHeader title={<span className="text-gray-300" style={{ color: theme.palette.text.secondary }}>Contaxt</span>} />
                            <CardContent>
                                <div className="space-y-4 text-gray-200">
                                    <div className="flex" style={{ color: theme.palette.text.secondary }}>
                                    ...
                                    <div className="flex" style={{ color: theme.palette.text.secondary }}>
                                        ...
                                        <div className="flex text-gray-400 items-center pb-3 gap-5" style={{ color: theme.palette.text.secondary }}>
                                            <span className="pr-5">-</span>
