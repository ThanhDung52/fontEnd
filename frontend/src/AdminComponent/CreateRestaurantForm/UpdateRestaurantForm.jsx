import { Button, CircularProgress, Grid, IconButton, Modal, TextField } from "@mui/material";
...
import { createRestaurant, getRestaurantByUserId, updateRestaurant } from "../../component/State/Restaurant/Action";
...
const UpdateRestaurantForm = ({restaurantData,  onUpdateSuccess}) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            ...
            dispacth(updateRestaurant({restaurantId:restaurant.userRestaurant.id,data,jwt}))
